...
var inputMethodManager = new InputMethodManager();
// XXX: For now let's pass a fake app object.
inputMethodManager.app = {
...
function deactivateInputMethod() {
  // Switch to default IMEngine makes the current IMEngine deactivate.
  // The currentIMEngine will be set and activate again in
