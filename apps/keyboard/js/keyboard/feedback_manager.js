...
SoundFeedback.prototype.triggerFeedback = function(isSpecialKey) {
  if (!this.settings.initialized) {
...
FeedbackManager.prototype.triggerFeedback = function(isSpecialKey) {
  this.vibrationFeedback.triggerFeedback(isSpecialKey);
  this.soundFeedback.triggerFeedback(isSpecialKey);
};
